$(function() {
    'use strict';
    var readerControl, docViewer, am;
    ...
    function colorSelectedHandler($element, $colorPicker) {
        ...
        if (isRemovingColors) {
            ...
            if (colorName !== 'transparent') {
                ...
                currentToolColors = window.ControlUtils.getToolColors(annotation);
                $element.remove();
            }
    ...
    function setupAnnotationEditDialog() {
        ...
        $selectAddColor.on('click', function() {
            if (!$(this).hasClass('disabled')) {
                ...
                window.ControlUtils.addToolColor(window.ControlUtils.getSelectedAnnotation(), selectedColorPicker, selectedColor);
                // refresh the list
                selectColorTab(selectedColorPicker);
